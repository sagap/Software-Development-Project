...
public class Buyer {
    ...
    // psaxnei gia spitia apo ti vasi
    public String search(String username)
    {
        ...
        if(kataskevi2 == null)
        {   
        h = (new HouseHelper()).House_search(regions,this.value1,this.value2,this.kataskevi1,this.t1,this.t2,this.thermansi,this.single,username);
        }
        else
        {
        h = (new HouseHelper()).House_search1(regions,this.value1,this.value2,this.kataskevi1,this.kataskevi2,this.t1,this.t2,this.thermansi,this.single,username);
        ...
        {
           System.out.println("ela re ! "+h.get(i).getHouses().getOdos()+"yiha");
        
        }
           // barh ton algorithmon
        ...
        System.out.println("edwwwghfhgbvdfww"+ w[0] +"  "+w[1]+" " +w[2]+" " +w[3]+" " +w[4]);
        if(h != null )
        {
            noHouses = "";
